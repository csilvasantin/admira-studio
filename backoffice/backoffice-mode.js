(function() {
  ...
  banner.textContent = '🛠 BACKOFFICE — Editable texts version (admira.studio/backoffice) — Changes saved in browser only';
  ...
  console.log('%c[Admira Studio GOD] Text editor loaded. Use the toolbar in bottom-right. Edits saved locally.', 'color:#68dce9');
})();
