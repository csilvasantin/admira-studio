(function() {
  ...
  const CLIENT_ID = '861856772040-quq6ut76k4mqj3fdq87h6g6caht3nm4l.apps.googleusercontent.com'; // OAuth 2.0 Web Client (proyecto admira-app). Orígenes JS autorizados deben incluir https://www.admira.studio y https://admira.studio
    ...
    overlay.innerHTML = `
      <div style="max-width: 420px; width: 90%; background: #111a20; border: 1px solid #68dce9; border-radius: 12px; padding: 40px 32px; text-align: center;">
        ...
        <p style="font-size: 12px; color: #6b7280; margin-top: 24px;">
          ...
          Inicia sesión con Google para gestionar Admira Studio.
        </p>
      </div>
    `;
