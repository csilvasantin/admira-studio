/**
 * Reenvío a admiranext.com — el motor común de admira.studio/tiktok.
 * ================================================================
 * El compositor de TikTok es la capa CREAR, así que su URL pública debe ser
 * Admira Studio; pero su código y su backend viven en admiranext.com, detrás de la
 ...
 *    prefijo YA EXISTE en Admira Studio con otros ficheros. El cuerpo se reescribe al
...
export async function proxyToAdmiranext(context, rest, area) {
  ...
  // La piel de Admira Studio se sirve AQUI, no se pide arriba: es nuestra, no del
  ...
  // Una redirección a admiranext sacaría al usuario de admira.studio a mitad de faena.
