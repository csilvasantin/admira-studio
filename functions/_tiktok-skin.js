/**
 * Piel de Admira Studio para el compositor de TikTok (FLT-1202, Carlos 5-ago-2026).
 * ==========================================================================
 ...
 * puerta de Admira Studio. admiranext.com/tiktok sigue exactamente igual.
 *
 ...
 * Admira Studio (assets/styles.css). Lo que el compositor cambie mañana seguirá
 * saliendo vestido de Admira Studio sin tocar nada aquí.
 *
 * Correspondencia (izquierda compositor · derecha Admira Studio):
 ...
 * El rosa y el morado del compositor no existen en Admira Studio: se llevan a coral y
 * oro, que son los acentos que sí usa el sitio, en vez de inventar dos colores.
 */
export const SKIN_PATH = '_skin.css';
// Sello propio de la piel. El _headers de Admira Studio le impone 4 h de cache y la
...
/* 2. TIPOGRAFIA. Admira Studio es monoespaciada de arriba abajo; el compositor traia
...
/* 5. RESPLANDOR. En Admira Studio el acento no es plano: brilla. */
 ...
 * Admira Studio y de AdmiraNeXT a proposito en varios sitios, y arrasarlo mentiria.
 * El enlace de la marca pasa a la home de Admira Studio, que es donde el visitante
 * espera volver.
 */
function marcaDeLaPuerta(html) {
  return html
    .replace('<span>ADmiraNeXT · TikTok</span>', '<span>Admira Studio · TikTok</span>')
    .replace('aria-label="Volver a ADmiraNeXT"', 'aria-label="Volver a Admira Studio"')
    .replace('aria-label="Herramientas ADmiraNeXT"', 'aria-label="Herramientas de Admira Studio"')
    .replace('<title>TikTok Ads 25s · ADmiraNeXT</title>', '<title>TikTok Ads 25s · Admira Studio</title>');
}
