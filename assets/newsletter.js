/* Newsletter Admira Studio — captura de emails del radar.
...
(function () {
  ...
  var MAILTO = 'mailto:hola@admiranext.com?subject=Admira Studio%20radar&body=I%20want%20to%20receive%20the%20Admira Studio%20radar.';
  var EMAIL_RE = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
